...
const Excelsior25 = () => {
  ...
  useEffect(() => {
    ...
    if (canvas) {
      ...
      handleSparkleResize = function () {
        canvas.width = window.innerWidth;
        canvas.height = window.innerHeight * 0.9;
      };
      window.addEventListener("resize", handleSparkleResize);
      handleSparkleResize();
    ...
    return () => {
      if (handleSparkleResize) {
        window.removeEventListener("resize", handleSparkleResize);
      }
      ...
      <main id="hero" className="hero">
        <div className="hero-wrap">
          ...
          <div className="hero-right">
            <img
              src="/images/Excelsior2025/EX25-logo.png"
              alt="Excelsior logo"
              className="card-img"
              style={{
                opacity: "90%",
        ...
        <div className="section-inner glass">
          ...
          <div className="tiles">
            <div className="tile glass">
              <img
                src="/images/Excelsior2025/1000131263.jpg"
                alt="Workshop vibe"
              />
              <h3>Workshops</h3>
            ...
            <div className="tile glass">
              <img
                src="/images/Excelsior2025/1000131261.jpg"
                alt="Stage lights"
              />
              <h3>Performances</h3>
              <p>
            ...
            <div className="tile glass">
              <img
                src="/images/Excelsior2025/1000131254.jpg"
                alt="Hackathon night"
              />
              <h3>Build Nights</h3>
