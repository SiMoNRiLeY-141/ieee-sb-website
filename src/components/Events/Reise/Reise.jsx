        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 border border-blue-100">
            ...
            <p className="text-blue-700 leading-relaxed text-base sm:text-lg">
              ...
              and 8, 2025 — in the various department laboratories of GEC
              Palakkad. We are expecting around 30 students from Grades 8 and 9
              from nearby schools, coordinated through the Block Resource Center
              (BRC), Kadampuram, Kazhipuram, Palakkad.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 border border-blue-100">
            ...
            <p className="text-blue-700 leading-relaxed text-base sm:text-lg mb-6">
              The core aim of this program is to introduce school students to
              the fundamentals of science, technology, and career planning
              through engaging hands-on sessions across different engineering
              domains. Each workshop is curated to bridge the gap between school
              curriculum and real-world applications, thereby nurturing their
              curiosity and interest in STEM careers.
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {[
                {
                  dept: "CE",
                  desc: "Introduction to mechanical properties, test of materials"
                },
                {
                  dept: "EEE",
                  desc: "Introduction to basics of digital electronics"
                },
                { dept: "IT", desc: "Introduction to chatbot making" },
                { dept: "CSE", desc: "Introduction to cybersecurity" },
                {
                  dept: "ME",
                  desc: "Study of mechanical tools, components and their applications"
                },
                ...
                >
                  ...
                  <span className="text-blue-700 ml-2 text-sm sm:text-base">
                    {item.desc}
                  </span>
                </div>
              ))}
